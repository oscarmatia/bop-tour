...
<html>
  <head>
    ...
    <script src="redireccion_iniciar_sesion_visitar.js"></script>
    <script src="redireccion_registro_visitar.js"></script>
    ...
    <div class="contenedor" style="">
      ...
      <div class="login">
          ...
          <h3>Inicio de Sesión</h3>
           ...
           <form class="" action="validar_visitar.php" method="post">
            ...
            <input class="boton" type="submit" name="inicio" value="Iniciar Sesión" onclick="sesion_iniciada_visitar()">

          </form>
          <input class="boton2" type="submit" name="Registro" value="Registrarme" onclick="redireccion_registro_visitar()" style="margin-left: 25%; margin-top: 1%;padding: 6px;">
      </div>
